...
MLFLOW_TRAINING_EXPERIMENT_NAME = "fraud-detection-training"
MLFLOW_VALIDATION_EXPERIMENT_NAME = "fraud-detection-validation"
MLFLOW_TEST_EXPERIMENT_NAME = "fraud-detection-test"
